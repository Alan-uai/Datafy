...
function DashboardActions({ isEditingWidgets, onWidgetEditToggle, columnVisibility, onColumnVisibilityChange }: DashboardActionsProps) {
  return (
...
interface DashboardHeaderProps extends DashboardActionsProps {
    // Inherits all props from DashboardActionsProps
}
